 ...
 * Figma collection: "Semantic" (node 265-2169)
 * Source: Figma MCP — exact values per mode
 *
 * Figma variable modes (exactly 3):
 *   Tenpercent    — tenpersent brand, light, SUIT font
...
// ── Text&Icon ─────────────────────────────────────────────
// Tenpercent (default / light mode) values
export const textIcon = {
  ...
  Subtle:        ref('Neutral/150',             palette.neutral[150]),
  Base:          ref('Neutral/White',           palette.neutral.White),
  'Base-sub':    ref('Neutral/100',             palette.neutral[100]),
  Primary:       ref('Brand/Tenpersent/500',    palette.tenpersent[500]),
  PrimaryStrong: ref('Brand/Tenpersent/600',    palette.tenpersent[600]),
...
export const surface = {
  ...
  Base:           ref('Neutral/White',          palette.neutral.White),
  PrimarySolid:   ref('Brand/Tenpersent/500',   palette.tenpersent[500]),
  PrimarySubtle:  ref('Brand/Tenpersent/50',    palette.tenpersent[50]),
...
export const border = {
  ...
  Heavy:          ref('Overlay-Black/40',       palette.overlayBlack[40]),
  PrimarySolid:   ref('Brand/Tenpersent/400',   palette.tenpersent[400]),
  PrimarySubtle:  ref('Brand/Tenpersent/100',   palette.tenpersent[100]),
...
// ── Dimmer ────────────────────────────────────────────────
export const dimmer = {
  Strong: ref('Overlay-Black/80', palette.overlayBlack[80]),
...
export const modes = {
  tenpercent: {
    ...
    fontName:   'SUIT',
    isDark:     false,
    paletteKey: 'tenpersent',
    primary: {
      TextIcon:      { palettePath: 'Brand/Tenpersent/500', value: palette.tenpersent[500] },
      BgSolid:       { palettePath: 'Brand/Tenpersent/500', value: palette.tenpersent[500] },
      BgSubtle:      { palettePath: 'Brand/Tenpersent/50',  value: palette.tenpersent[50]  },
      BdSolid:       { palettePath: 'Brand/Tenpersent/400', value: palette.tenpersent[400] },
      BdSubtle:      { palettePath: 'Brand/Tenpersent/100', value: palette.tenpersent[100] },
    },
  },
  'compose-dark': {
    name:       '컴포즈 (Dark)',
    ...
    primary: {
      ...
      BdSolid:       { palettePath: 'Brand/Compose/500', value: palette.compose[500] },
      BdSubtle:      { palettePath: 'Brand/Compose/900', value: palette.compose[900] },
    },
  },
  'compose-light': {
    name:       '컴포즈 (Light)',
    ...
    primary: {
      ...
      BdSolid:       { palettePath: 'Brand/Compose/300', value: palette.compose[300] },
...
// Primary (Tenpercent default)
register('primary-text-icon',  'Primary/Text&Icon', 'Brand/Tenpersent/500', palette.tenpersent[500])
register('primary-bgsolid',    'Primary/BgSolid',   'Brand/Tenpersent/500', palette.tenpersent[500])
register('primary-bgsubtle',   'Primary/BgSubtle',  'Brand/Tenpersent/50',  palette.tenpersent[50])
register('primary-bdsolid',    'Primary/BdSolid',   'Brand/Tenpersent/400', palette.tenpersent[400])
register('primary-bdsubtle',   'Primary/BdSubtle',  'Brand/Tenpersent/100', palette.tenpersent[100])
...
register('text-icon-subtle',      'Color/Text&Icon/Subtle',      'Neutral/150',         palette.neutral[150])
...
register('text-icon-primary',        'Color/Text&Icon/Primary',       'Brand/Tenpersent/500', palette.tenpersent[500])
register('text-icon-primary-strong', 'Color/Text&Icon/PrimaryStrong', 'Brand/Tenpersent/600', palette.tenpersent[600])
...
register('surface-primary-solid',   'Color/Surface/PrimarySolid',   'Brand/Tenpersent/500',  palette.tenpersent[500])
register('surface-primary-subtle',  'Color/Surface/PrimarySubtle',  'Brand/Tenpersent/50',   palette.tenpersent[50])
...
register('border-heavy',           'Color/Border/Heavy',          'Overlay-Black/40',      palette.overlayBlack[40])
register('border-primary-solid',   'Color/Border/PrimarySolid',   'Brand/Tenpersent/400',  palette.tenpersent[400])
register('border-primary-subtle',  'Color/Border/PrimarySubtle',  'Brand/Tenpersent/100',  palette.tenpersent[100])
...
// Dimmer
register('dimmer-strong', 'Color/Dimmer/Strong', 'Overlay-Black/80', palette.overlayBlack[80])
